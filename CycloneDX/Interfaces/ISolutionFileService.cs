...
namespace CycloneDX.Interfaces
{
    public interface ISolutionFileService
    {
        ...
        Task<HashSet<DotnetDependency>> GetSolutionDotnetDependencys(string solutionFilePath, string baseIntermediateOutputPath, bool excludeTestProjects, string framework, string runtime, string configuration);
    }
}
