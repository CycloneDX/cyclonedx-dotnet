    ...
    public static class Program
    {
        public static Task<int> Main(string[] args)
        {
            ...
            var specVersion = new Option<string>(
                ...
                getDefaultValue: () => SpecificationVersionHelpers.VersionString(SpecificationVersionHelpers.CurrentVersion));
            ...
            rootCommand.SetHandler(async (context) =>
            {
                RunOptions options = new RunOptions
                {
                    ...
                    specVersion = SpecificationVersionHelpers.Version(context.ParseResult.GetValueForOption(specVersion))
                };
