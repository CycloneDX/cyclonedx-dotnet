...
namespace CycloneDX
{
    public static class Program
    {
        public static async Task<int> Main(string[] args)
        {
            ...
            var framework = new Option<string>("--framewok", "-tfm") { Description = "The target framework to use. If not defined, all will be aggregated." };            
            ...
            var dotnetCommandTimeout = new Option<int>("--dotnet-command-timeout", "-dct") { Description = "dotnet command timeout in milliseconds (primarily used for long dotnet restore operations)" };
            ...
            var setType = new Option<Component.Classification>("--set-type", "-st") { Description = "Override the default BOM metadata component type (defaults to application)." };
