...
namespace CycloneDX
{
    public static class Program
    {
        public static async Task<int> Main(string[] args)
        {
            ...
            var dotnetCommandTimeout = new Option<int>("--dotnet-command-timeout", "-dct") { Description = "dotnet command timeout in milliseconds (primarily used for long dotnet restore operations)", DefaultValue = 300000 };
