...
namespace CycloneDX
{
    public static class Program
    {
        public static Task<int> Main(string[] args)
        {
            ...
            var includeProjectReferences = new Option<bool>(new[] { "--include-project-references", "-ipr" }, "EXPERIMENTAL Include project references as components (can only be used with project files).");
